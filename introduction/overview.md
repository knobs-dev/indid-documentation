...
## What is Indid?
Indid is a Smart Wallet infrastructure that simplifies web3 development. We leverage Account Abstraction (ERC‑4337) to offer a frictionless UX: you build with simple APIs/SDKs while we handle sponsorship, relaying, and wallet operations behind the scenes.
